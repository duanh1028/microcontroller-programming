...
static void action(char **words) {
    ...
    if (words[0] != 0) {
        ...
        if (strcasecmp(words[0],"gen") == 0) {
            ...
            step = temp * N / 100000.0 * (1 << 16);
            printf("finished\n");
            return;
        }
        if (strcasecmp(words[0],"440") == 0) {
            step = 440 * N / 100000.0 * (1 << 16);
            printf("freq 440\n");
            return;
        }
        if (strcasecmp(words[0],"650") == 0) {
            step = 650 * N / 100000.0 * (1 << 16);
            printf("freq 650\n");
            return;
        }
        if (strcasecmp(words[0],"750") == 0) {
            step = 750 * N / 100000.0 * (1 << 16);
